...
void loop() {
  ...
  sonoro = digitalRead(8);

  if(sonoro==LOW)
  {
    display.setCursor(35, 30); //Definição de onde o texto será escrito. Lembre se que: linha, coluna; eixo x / eixo y
    display.print("SOM"); //Texto a ser escrito;
